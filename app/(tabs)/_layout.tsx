...
const STANDARD_TABS = [
  { name: 'index',     label: 'Inicio',     icon: 'home-outline' as const },
  { name: 'exercises', label: 'Ejercicios', icon: 'barbell-outline' as const },
  { name: 'social',    label: 'Social',     icon: 'people-outline' as const },
